  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-full max-w-sm text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">AIRI 회의비 관리</h1>
        <p className="text-sm text-gray-500 mb-8">군 장병 AI SW 역량강화 사업</p>
        ...
        <p className="text-xs text-gray-400 mt-6">@airi.kr 계정만 접근 가능합니다.</p>
      </div>
    </div>
  );
}
